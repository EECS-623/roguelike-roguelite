class_name DashDraugr extends CharacterBody2D

@onready var animation_player : AnimationPlayer = $AnimationPlayer
@onready var dash_draugr_state_machine : DashDraugrStateMachine = $DashDraugrStateMachine
...
func _ready() -> void:
	add_to_group("enemy")
	dash_draugr_state_machine.initialize(self)
